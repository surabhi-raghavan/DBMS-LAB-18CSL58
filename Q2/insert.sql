insert all 
    ...
    into salesman values(2000, 'Julia', 'Jaisalmer', '23%')
...
insert all 
    ...
    into customer values(4, 'Beidou', 'Mangalore', 60, 4000)
select * from dual; 

insert all
    into orders values(1, 1000, '11-JAN-2022', 1, 1000)
    into orders values(2, 2000, '11-JAN-2022',2, 5000)
    into orders values(3, 2000, '12-JAN-2022', 1, 3000)
    into orders values(4, 3000, '13-JAN-2022', 2, 4000)
select   * from dual; 